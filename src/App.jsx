...
function App() {
  ...
  async function handleSelectPlace(selectedPlace) {
    setUserPlaces((prevPickedPlaces) => {
      ...
      //if user selected a place from available places which is already previously selected,
      //then simply return the same previous places, else return the previous places + newly selected place
